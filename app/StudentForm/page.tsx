...
//   router.push(/)
  ...
  return (
    <div style={{ padding: "4vh", backgroundColor: "#f5f5f5", minHeight: "100vh" }}>
    <h1 style={{
      textAlign: "center",
      color: "#333",
      marginBottom: "3vh",
      ...
      fontWeight: "600"
        ...
        Kindly fill all the details of the form</h1>
...
/>
     ...
     style={{
      ...
      onMouseOut={(e) => (e.currentTarget.style.backgroundColor = "rgba(223, 100, 6, 0.92)")} 
